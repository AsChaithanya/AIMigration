...
Class : AbstractClinicServiceTests
...
Relevant Documents
[Relationship]
JdbcOwnerRepositoryImpl uses EntityUtils. JdbcPetRepositoryImpl uses OwnerRepository. JdbcPetRepositoryImpl uses VisitRepository. JdbcPetRepositoryImpl uses EntityUtils. JdbcVetRepositoryImpl uses EntityUtils. ClinicServiceImpl uses PetRepository. ClinicServiceImpl uses VetRepository. ClinicServiceImpl uses OwnerRepository. ClinicServiceImpl uses VisitRepository. OwnerController uses ClinicService. PetController uses ClinicService. PetTypeFormatter uses ClinicService. PetValidator uses Pet. VetController uses ClinicService. VisitController uses ClinicService. AbstractClinicServiceTests uses ClinicService. AbstractClinicServiceTests uses EntityUtils. CrashControllerTests uses CrashController. OwnerControllerTests uses OwnerController. OwnerControllerTests uses ClinicService. PetControllerTests uses PetController. PetControllerTests uses ClinicService. PetTypeFormatterTests uses ClinicService. VetControllerTests uses VetController. VetControllerTests uses ClinicService. VisitControllerTests uses VisitController. VisitControllerTests uses ClinicService.
